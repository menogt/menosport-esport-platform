...
import { ArrowLeft, Camera, Check, MapPin, Save, Shield, UserRound } from "lucide-react";
...
export default function ProfilePage() {
  ...
  const [form, setForm] = useState({ handle: "", bio: "", region: "", primaryGame: "", avatarUrl: "" });
  ...
  async function onAvatarPicked(file: File | undefined) {
    ...
    try {
      ...
      updateProfile.mutate({ ...form, avatarUrl: url });
